...
public class MyCollectionActivity extends BaseActivity {
    ...
    protected void init() {
        ...
        //添加页卡视图
        mViewList.add(ExpressCollectionFragment.newInstance());
        mViewList.add(FunkCollectionFragment.newInstance());
        mViewList.add(ForumCollectionFragment.newInstance());
        ...
        viewPagerTabs.addTab(viewPagerTabs.newTab().setText(mTitleList.get(2)));
    ...
    protected int getLayoutId() {
        return R.layout.mine_collection_act;
    }
