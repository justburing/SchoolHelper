...
public class ChatEmoticonsToolBarView extends EmoticonsToolBarView {

    public ChatEmoticonsToolBarView(Context context) {
        super(context);
    }

    public ChatEmoticonsToolBarView(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    protected View getCommonItemToolBtn() {
        return mInflater == null ? null : mInflater.inflate(R.layout.item_toolbtn_comment_kb, null);
    }
