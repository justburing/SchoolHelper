...
public class ChatEmoticonsKeyBoard extends AutoHeightLayout implements EmoticonsFuncView.OnEmoticonsPageViewListener,
...
//    ImageView btnHongbao;
    ...
    public ChatEmoticonsKeyBoard(Context context, AttributeSet attrs) {
        ...
        View view = mInflater.inflate(R.layout.view_keyboard_chat, this);
...
//                break;
    ...
    void btn_voice() {
        ...
        setFuncViewHeight(EmoticonsKeyboardUtils.dip2px(getContext(), APPS_HEIGHT / 2));
    }
